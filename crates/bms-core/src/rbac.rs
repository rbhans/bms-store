...
impl Permission {
    ...
    pub fn key(&self) -> &'static str {
        match self {
            ...
            Self::ManageCommissioning => "manage_commissioning",
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            Self::ManageCommissioning => "Manage Commissioning",
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Self::ManageCommissioning => "Verify and sign off device commissioning checklists",
    ...
    pub fn from_key(key: &str) -> Option<Permission> {
        match key {
            ...
            "manage_commissioning" => Some(Self::ManageCommissioning),
